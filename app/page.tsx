...
const telegrams = ["https://t.me/polivchi", "https://t.me/polivchi2"]

const locations = [
  {
    name: "Главний филиал Поливчи Саттепо",
      ...
      <div className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <MainAccordion phones={phones} telegrams={telegrams} locations={locations} />
          </div>
        </div>
      </div>
      <Footer />
